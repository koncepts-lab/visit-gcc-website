    ...
    useEffect(() => {
        const fetchTabs = async () => {
            ...
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}holiday-themes`, {
                    headers: {
                ...
                // Add "All Themes" tab at the beginning
                const allTabsData = [
                    {
                        id: "all",
                        name: "All Themes",
                        description: "Explore all our exciting holiday packages across various themes."
                    },
                    ...formattedTabs
                ];
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-6 p-0 d-flex pb-2 ms-md-0 ms-3">
                            <img
                                src={displayPackages[0]?.photo_urls?.[0] || "../images/tour/358-608.jpg"}
                        ...
                        <div className="col-md-3">
                            <div className={style["tour-holidays-box"]}>
                                <img 
                                    src={displayPackages[1]?.photo_urls?.[0] || "../images/tour/269-273.jpg"} 
                                    className="w-100" 
                                    alt="Destination" 
                                />
                                <span>
                            ...
                            <div className={`mb-0 ${style["tour-holidays-box"]} ${style["mobile-pb"]}`}>
                                <img 
                                    src={displayPackages[2]?.photo_urls?.[0] || "../images/tour/02.jpg"} 
                                    className="w-100" 
                                    alt="Destination" 
                                />
                                <span>
                        ...
                        <div className="col-md-3">
                            <div className={style["tour-holidays-box"]}>
                                <img 
                                    src={displayPackages[3]?.photo_urls?.[0] || "../images/tour/03.jpg"} 
                                    className="w-100" 
                                    alt="Destination" 
                                />
                                <span>
                            ...
                            <div className={`mb-0 ${style["tour-holidays-box"]}`}>
                                <img 
                                    src={displayPackages[4]?.photo_urls?.[0] || "../images/tour/04.jpg"} 
                                    className="w-100" 
                                    alt="Destination" 
                                />
                                <span>
                            ...
                            <div className={style['country-container']}>
                                <ul className={`nav nav-tabs border-0 ${style["country-nav-tabs"]}`} id="myTab" role="tablist">
                                    {tabsData.map((tab, index) => (
                                        <li key={tab.id} className={`nav-item ${style["country-nav-item"]}`} role="presentation">
                                            <button
                                                className={`nav-link border-0 ${style['country-nav-link']} ${activeTab === tab.id ? 'active' : ''}`}
                                                id={`${tab.id}-tab`}
                                                data-bs-toggle="tab"
