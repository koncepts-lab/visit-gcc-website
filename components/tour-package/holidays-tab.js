                      ...
                      <div className="container">
                        <div className="row">
                          <div className="col-md-3 p-0">
                            <img
                              src="../images/tour/358-608.jpg"
                              className={style["img-Holidays"]}
                            />
                          </div>
                          <div
                            className={`col-md-3 p-0 ${style["vertical-center"]}`}
                          >
                          ...
                          <div className="col-md-3">
                            ...
                            <div
                              className={`mb-0 ${style["tour-holidays-box"]}`}
                            >
                              <img
                                src="../images/tour/04.jpg"
                                className="w-100"
                              />
                              <span>
                                <h6>Destination</h6>
