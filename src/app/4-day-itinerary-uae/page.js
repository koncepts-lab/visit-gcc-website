                ...
                <div className={`container ${style['container-package-details']}`}>
                    <div className='row'>
                        <div className='col-md-5'>
                            <h3>4-day itinerary UAE</h3>
                            <p>
                                <Link href='#0'>UAE</Link>
                            </p>
                ...
                <div className='container'>
                    <div className='row pt-2'>
                        <div className='col-md-12'>
                            ...
                            <li>Desert safari with luxury camp setup</li>
                            <li>Private tours of mosques and museums</li>
                            <li>Sunset dinner cruise and cocktail </li>
                ...
                <div className='container'>
                    <div className='row pt-2'>
                        <div className='col-md-12'>
                            ...
                            <li>Skydiving or hot air balloon ride</li>
                            <li>Private yacht cruise</li>
                            <li>Falconry experience</li>
                ...
                <div className='container'>
                    <div className='row pt-2'>
                        <div className='col-md-12'>
                            ...
                            Accommodation       :  $3,000 - $6,000 per person<br />
	Transportation          :  $1,500 - $3,000 per person<br />
	Activities and meals :  $2,500 - $5,000 per person<br />
	Total                         :  $7,000 - $14,000 per person
