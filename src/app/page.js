    ...
    <>
      ...
      <div className={`container ${style['home-add-banner']}`}>
        <div className="row">
          ...
          <img
              src={banners.find(banner => banner?.name === 'homepage-first-banner-lap')?.url}
              className='lap-view'
              alt="Banner for Laptop"
            />
            <img
              src={banners.find(banner => banner?.name === 'homepage-first-banner-mobile')?.url}
      ...
      <div className={`container ${style['home-add-banner']}`}>
        <div className="row">
          <div className="col-md-12 pdb-3">
            <img src={banners.find(banner => banner?.name === 'homepage-second-banner-lap')?.url} className='lap-view' alt="Banner-second-lap" />
            <img src={banners.find(banner => banner?.name === 'homepage-second-banner-mobile')?.url} className='mobile-view' alt="Banner-second-mobile" />
          </div>
        </div>
      </div>
