...
const DatePickerWithHover = ({ onClose, eventId, type = "event" }) => {
    ...
    const [eventDateRange, setEventDateRange] = useState({ start: null, end: null });
    ...
    // MODIFIED: Simplified to display a single selected date.
    ...
    // MODIFIED: Logic updated to handle a single date for start and end dates.
    const handleBookNow = () => {
        if (!selectedDate) {
        ...
        const bookingData = {
            // Using the timezone-safe helper function for the same start and end date.
            ...
            <div className={`bg-white rounded-lg shadow-xl p-lg-6 p-2 ${style["date-pick"]}`}>
                <div className={`${style["date-left"]}`}>
                    ...
                    <div className="relative">
                        ...
                        {/* MODIFIED: Using 'selected' prop for single date selection instead of 'highlightDates' */}
                        <DatePicker
                    ...
                    <div className="mt-4 flex">
                        <Link href="/checkout" passHref>
                            <button
                                ...
                                // MODIFIED: Disabled logic updated for single date state.
