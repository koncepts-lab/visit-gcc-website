...
import CountriesOman from "../../../../components/countries/countries-oman";
  ...
  return (
    <div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h3>The Sultanate of Arabia: Authentic & Timeless </h3>
              <p>
              Journey through Oman’s majestic history, vibrant traditions, and flavorful culinary heritage amidst its breathtaking landscapes. Explore ancient forts, discover frankincense trails, and savor Shuwa (slow-cooked meat). Experience the genuine warmth and hospitality of Omanis.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className={style["section-documentation"]}>
        ...
        <DocumentationTabs countryName={"Oman"} />
      </div>
