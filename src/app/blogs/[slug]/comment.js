...
function CommentsSection({ blogSlug, blogUuid }) {
  ...
  const fetchRepliesForComment = async (commentUuid) => {
    try {
      ...
      console.error(
        `Error fetching replies for comment ${commentUuid}:`,
        error
      );
    }
  };
  ...
  return (
    <div>
      <h3 className="text-black pt-lg-4 pt-0" style={{ fontWeight: "600" }}>
        Comments
      </h3>
          ...
          {comments.length === 0 ? (
            ...
            >
              ...
              <p className="text-muted mb-4">
                Be the first to share your thoughts about this blog post! Your
                insights could spark an interesting discussion.
              </p>
              <div
            ...
            comments.map((comment) => (
              ...
              >
                <div className="d-flex gap-4">
                  <img
                    src={
                      comment.user_avatar || "https://i.pravatar.cc/40?img=3"
                    }
                    alt="User Avatar"
