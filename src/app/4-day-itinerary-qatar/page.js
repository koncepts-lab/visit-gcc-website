                ...
                <div className='container'>
                    <div className='row pt-5'>
                        <div className='col-md-12'>
                           ...
                           <li> The St. Regis Doha</li>
                           <li>The Ritz-Carlton, Doha</li>
                        </ol>
                            </p>
                        </div>
                    </div>
                ...
                <div className='container'>
                    <div className='row pt-2'>
                        <div className='col-md-12'>
                           ...
                           <li>Private tours of museums and cultural sites</li>
                           <li>Sunset dinner cruise</li>
                           <li>Skydiving or indoor skydiving experience</li>
                        </ol>
                            </p>
                        </div>
                    </div>
                ...
                <div className='container'>
                    <div className='row pt-2'>
                        <div className='col-md-12'>
                            ...
                            <p>
                            Accommodation : $2,500 - $5,000 per person <br/>

Transportation : $1,000 - $2,000 per person<br/>

Activities and meals : $2,000 - $4,000 per person<br/>

Total : $5,500 - $11,000 per person
                            </p>
                        </div>
                    </div>
                </div>
