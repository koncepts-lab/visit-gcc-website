        ...
        <>
            ...
            <section className={style['tour-package-details']}>
                <div className={`container ${style['container-package-details']}`}>
                    <div className='row'>
                        <div className='col-md-5'>
                            <h3>7-Day Itinerary Saudi Arabia, Bahrain, Qatar</h3>
                            <p>
                ...
                <div className={`container ${style['time']}`}>
                    <div className='row'>
                        <div className='col-md-12'>
                            <ItinerarySaudiArabiaBahrainQatar />
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row pt-2'>
                        <div className='col-md-12'>
                            ...
                            <p>
                            Accommodation        :   $4,000 - $6,000 per person<br />
	Transportation          :   $2,500 - $4,000 per person<br />
	Activities and meals :    $2,500 - $4,000 per person<br />

Total                           :   $9,000 - $14,000 per person
