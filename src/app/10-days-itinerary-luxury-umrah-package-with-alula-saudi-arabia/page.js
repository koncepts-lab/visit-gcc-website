        ...
        <div className={`container ${style["container-package-details"]}`}>
          <div className="row">
            <div className="col-md-5">
              <h3>
                10 days itinerary luxury Umrah package with AlUla, Saudi Arabia
              </h3>
              <p>
          ...
          <div className="row">
            ...
            <div className="col-md-5 align-items">
              <div className={style["mobile-mrb"]}>
                <h3>
                  10 days itinerary luxury Umrah package with AlUla, Saudi
                  Arabia
                </h3>
                <p></p>
              </div>
          ...
          <div className="row mt-5">
            <div className={`col-md-7 ${style["border-right"]}`}>
              ...
              <div className={style["inclusions"]}>
                <span>
                  <RiBusFill />
                  <div className="clearfix"></div> Volvo
                </span>
                <span>
                  <FaBed />
                  <div className="clearfix"></div>3 stars
                </span>
                <span>
                  <IoIosCar />
                  <div className="clearfix"></div>Transfer
                </span>
                <span>
                  <GiHotMeal />
                  <div className="clearfix"></div>Meals
                </span>
                <span>
                  <LiaBinocularsSolid />
          ...
          <div className="row pt-2">
            <div className="col-md-12">
              ...
              <p>
                <ol>
                  <li>
                    Private lectures on Islamic history and significance of
                    Umrah
                  </li>
        ...
        <div className="container">
          <div className="row pt-2">
            <div className="col-md-12">
              ...
              <p>
                Accommodation : $10,000 - $20,000 per person
                <br />
                Transportation : $5,000 - $10,000 per person
                <br />
                Activities and meals : $5,000 - $10,000 per person
                <br />
        ...
        <div className="container">
          <div className="row pt-5">
            <div className="col-md-12">
              ...
              <textarea
                placeholder="Could you share a review about your experience ?"
