            ...
            <div className="col-md-6">
              <div className={style["btn-first-section"]}>
                <div>
                  ...
                  <button className={style["btn-two"]}>
                    Why Partner with Us?
                  </button>
                </div>
              </div>
          ...
          <div className={`row ${style["pt-50"]}`}>
            <div className="col-md-6">
              <div className={style["mobile-padb"]}>
                <div className={style["pwu-box"]}>
                  <h4>Global Reach</h4>
                  <p>
                    Tap into a worldwide network of travelers eager to explore
                    the GCC region.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className={style["pwu-box"]}>
                ...
                <p>
                  Our services are designed to meet and exceed the needs of
                  every traveler.
                </p>
              </div>
            </div>
          ...
          <div className="row pt-4">
            <div className="col-md-6">
              <div className={style["mobile-padb"]}>
                <div className={style["pwu-box"]}>
                  ...
                  <p>
                    Leverage our robust marketing campaigns to boost your
            ...
            <div className="col-md-6">
              <div className={style["pwu-box"]}>
                ...
                <p>
                  Our priority is to understand and surpass customer
                  expectations.
                </p>
              </div>
            </div>
          ...
          <div className="row pt-4">
            <div className="col-md-6">
              <div className={style["mobile-padb"]}>
                <div className={style["pwu-box"]}>
                  ...
                  <p>
                    Access a vast audience of global travelers and local
                    adventurers.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className={style["pwu-box"]}>
                ...
                <p>
                  We customize our services to delight your customers and
              ...
              <div className={style["partner-with-us-form"]}>
                ...
                <div className="row">
                  ...
                  <div className="col-md-12 mb-3">
                    <button className={style["btn-one"]}>Submit Now</button>
                  </div>
                  <hr />
                  <div className="col-md-12">
